...
export default function Main() {
    ...
    async function handleSearch(event: FormEvent) {
        ...
        const response = await axios.get(`https://cors-anywhere.herokuapp.com/https://api.deezer.com/artist/${search}`);
    ...
    async function handleTopSongs() {
        const response = await axios.get(`https://cors-anywhere.herokuapp.com/https://api.deezer.com/artist/${artist?._id}/top`);
            ...
            <div className="content">
                {artist !== undefined && artist._type === "artist" ? (
                    <div className="result-card">
                        <header>
                            <h3><em>{artist._name}</em></h3>
                        </header>

                        <div className="card-content">
                            <img src={artist?._picture}
                                alt="result card" 
                                width="300px"
                                height="250px"
                            />
                        ...
                        <footer>
                            ...
                            <button onClick={handleTopSongs}>
                                <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-caret-right" width="24" height="24" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
                                <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
